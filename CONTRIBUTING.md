...
- Add it to the bottom of the category that fits best. If none fits, say so in the PR and propose one.
...
Submitting your own project is fine and you must say it's yours in the PR. The same bar applies.
